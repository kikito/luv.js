...
},getCoveringAABB:function(t){var i=Math.min(this.l,t.l),e=Math.min(this.t,t.t),n=Math.max(this.r,t.r),r=Math.max(this.b,t.b);return Luv.Collider.AABB(i,e,n-i,r-e)},getNearestPointInPerimeter:function(t,i){return{x:Math.abs(this.l-t)<Math.abs(this.r-t)?this.l:this.r,y:Math.abs(this.t-i)<Math.abs(this.b-i)?this.t:this.b}},collide:function(i,e,n){var r,o,s,u,a,h,c,f=this;return(0!==e||0!==n)&&(f=Luv.Collider.AABB(this.l-e,this.l-n,this.w,this.h)),o=f.getMinkowskyDiff(i),o.containsPoint(0,0)?(s=o.getNearestPointInPerimeter(0,0),r={dx:s.x-e,dy:s.y-n,ti:0,tunneling:!1}):(a=t(o,0,0,e,n,0,1),a&&(h=a.t0,c=a.t1,h>0&&1>h?u=h:c>0&&1>c&&(u=c),u?r={dx:e*u,dy:n*u,ti:u,tunneling:!0}:(o=this.getMinkowskyDiff(i),o.containsPoint(0,0)&&(s=o.getNearestPointInPerimeter(0,0),r={dx:s.x-e,dy:s.y-n,ti:0,tunneling:!1})))),r}});var t=function(t,i,e,n,r,o,s){for(var u,a,h,c=o||0,f=s||1,l=0;4>l;l++){switch(l){case 0:u=-n,a=i-t.l;break;case 1:u=n,a=t.r-i;break;case 2:u=-r,a=e-t.t;break;default:u=r,a=t.b-e}if(0===u){if(0>a)return}else if(h=a/u,0>u){if(h>f)return;h>c&&(c=h)}else{if(c>h)return;f>h&&(f=h)}}return{t0:c,t1:f}},i=function(i,e,n,r,o,s,u){var a=t(i,e,n,r,o,s,u);if(a){var h=a.t0,c=a.t1;return a.x0=e+h*r,a.y0=n+h*o,a.x1=e+c*r,a.y1=n+c*o,a.dx=r,a.dy=o,a}}}(),function(){var t=64,i=Luv.Collider.AABB;Luv.Collider.World=Luv.Class("Luv.Collider.World",{init:function(i,e){this.cellSize=i||t,this.items={},this.boxes={},this.rows={},this.itemCount=0,this.maxId=0,this.id=e||"world",this.itemsKey="_"+this.id+"_id"},getBox:function(t){var i=this.itemsKey;if(!t[i])throw Error("item must have the property "+i+" in order to obtain its box");var e=t[i];return this.boxes[e]},count:function(){return this.itemCount},add:function(t,n,r,o,s){var u=this.itemsKey;if(t[u])throw Error("item must not have the property "+u+" when inserting it in the world");var a=++this.maxId;return t[u]=a,this.boxes[a]=i(n,r,o,s),this.items[a]=t,this.itemCount++,e(this,a,this.boxes[a]),this.check(t)},move:function(t,i,r,o,s){var u=t[this.itemsKey];if(!u)throw Error("item must have the property "+this.itemsKey+" in order to be moved");var a=this.boxes[u];if(!a)throw Error("item "+u+" is not in the world. Add it to the world before trying to move it");var h=a.l,c=a.t;if(o=o===void 0?0:a.w,s=s===void 0?0:a.h,a.w!=o||a.h!=s){var f=a.getCenter();h=f.x-o/2,c=f.y-s/2}return(a.w!=o||a.h!=s||a.l!=i||a.t!=r)&&(n(this,u,a),a.setDimensions(i,r,o,s),e(this,u,a)),this.check(t,h,c)},check:function(t,e,n){var o=t[this.itemsKey];if(!o)throw Error("item was not inserted into the world before being checked");var s=this.boxes[o];if(!s)throw Error("item with id "+o+" was not inserted in the world");var u=s.l,a=s.t;e=e||u,n=n||a;var h=u-e,c=a-n,f=[],l={},d=s;if(e!=u||n!=a){var v=i(e,n,s.w,s.h);d=s.getCoveringAABB(v)}var g=d.toCellBox(this.cellSize);l[o]=!0;for(var p=g.t;g.b>=p;p++){var m=this.rows[p];if(m)for(var w=g.l;g.r>=w;w++){var L=m[w];if(L&&0!==L.itemCount)for(var y in L.ids)if(!l[y]&&L.ids.hasOwnProperty(y)){l[y]=!0;var b=this.boxes[y],A=s.collide(b,h,c);A&&(A.item=this.items[y],f.push(A))}}}return f.sort(r)},remove:function(t){var i=t[this.itemsKey];if(!i)throw Error("item must have property "+this.itemsKey+" in order to be removed from the world");var e=world.boxes[i];if(!e)throw Error("item "+i+" is not in the world. Add it to the world before trying to remove it");n(this,i,e),delete this.boxes[i],delete this.items[i],this.itemCount--},toGrid:function(t,i){return{x:Math.floor(t/this.cellSize),y:Math.floor(i/this.cellSize)}},fromGrid:function(t,i){return{x:t*this.cellSize,y:i*this.cellSize}}});var e=function(t,i,e){for(var n=e.toCellBox(this.cellSize),r=n.t;n.b>=r;r++)for(var o=this.rows[r]=this.rows[r]||{},s=n.l;n.r>=s;s++){var u=o[s]=o[s]||{itemCount:0,x:s,y:r,ids:{}};u.ids[i]||(u.ids[i]=!0,u.itemCount++)}},n=function(t,i,e){for(var n=e.toCellBox(t.cellSize),r=n.t;n.b>=r;r++){var o=t.rows[r];if(o)for(var s=n.l;n.r>=s;s++){var u=o[s];u&&u.ids[i]&&(delete u.ids[i],u.itemCount--)}}},r=function(t,i){var e=t.ti-i.ti;return e?0>e?-1:1:0}}();