...
(function() {
    Luv.Collider.AABB = Luv.Class("Luv.Collider.AABB", {
        ...
        getCoveringAABB: function(other) {
            var l = Math.min(this.l, other.l), t = Math.min(this.t, other.t), r = Math.max(this.r, other.r), b = Math.max(this.b, other.b);
            return Luv.Collider.AABB(l, t, r - l, b - t);
        },
    ...
    Luv.Collider.World = Luv.Class("Luv.Collider.World", {
            ...
            for (var cy = b.t; cy < b.b; cy++) {
                ...
                for (var cx = b.l; cx < b.r; cx++) {
                    ...
                    for (var other_id in cell.ids) {
                        ...
                        var oaabb = this.aabbs[other_id], col = collideAABBs(aabb, oaabb, vx, vy);
                        if (col) {
        ...
        drawItems: function(canvas) {
            for (var id in this.aabbs) {
                if (!this.aabbs.hasOwnProperty(id)) {
                    continue;
                }
                var aabb = this.aabbs[id];
